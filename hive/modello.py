...
class HiveModel(Model):
    def __init__(self, numbee, width, height, num_resources, percentage_foragers, percentage_nurses, percentage_guards):
        self.num_bee = numbee
